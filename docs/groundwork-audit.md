...
| Faster battle presentation | Battle overlay and upstream speed-up package | [Investigate independent model and attack animation rates](battle-animation-speed.md), preserving camera speed, event timing, turn/RNG logic, and music rate. Compare fixed-input battle outcomes. |
