...
All gameplay images are captures of the local Shinka runtime using the user's
owned European game data. They illustrate the requested modifications; they
are not AI-generated gameplay or promises of full-game compatibility.

| Published asset | Source and treatment |
| --- | --- |
| `dist/media/shinka-title.png` | Exact copy of `assets/branding/shinka-title.png`, derived from the user's full title artwork. |
...
without restarting playback. Chapter times are 0, 7.38, 14.42 and 21.44 seconds.
The capture is enlarged with nearest-neighbor scaling to 852×480; video encoding
repeats frames at 30 fps. No EQ, musical rearrangement or palette-specific gain
is added in post-production. AAC encoding is lossy.

Original game imagery, music and the reference-derived emblem retain their
respective rights. These selected excerpts are project showcase media, not a
redistributable disc-resource library. Locally generated music packs are excluded.
